        ...
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          >
            ...
            <button
              ...
              className="text-sm text-gray-400 px-3 py-2 rounded-xl hover:bg-gray-100 transition"
            >
              Logout 👋
            </button>
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-5 text-white">
              ...
              {!loading && stats?.dueToday > 0 ? (
                ...
                <div className="bg-white/20 rounded-xl p-3">
                  ...
                  <p className="text-purple-200 text-xs mt-0.5">
                    Kal dobara aao ya naye notes add karo
                  </p>
                </div>
              )}
            </div>
              ...
              <>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                      onClick={() => navigate('/')}
                      className="flex items-center gap-2 p-3 rounded-xl bg-gray-50 text-gray-700 font-medium text-sm hover:bg-gray-100 transition"
                    >
                      <span className="text-xl">🏠</span>
                      Go To Home Page
                    </button>
...
function MotivationalQuote() {
  ...
  const quotes = [
    { text: "Padhai aaj ki mehnat — kal ki kamiyabi!", author: "MindOS" },
    { text: "Ek ek card — ek ek step aage!", author: "MindOS" },
    { text: "Consistency beats talent — roz thoda thoda!", author: "MindOS" },
    { text: "Jo aaj sikh liya — wo zindagi bhar kaam aayega!", author: "MindOS" },
    { text: "Brain gym karo — har roz thodi practice!", author: "MindOS" },
    { text: "Failure nahi — sirf feedback hai!", author: "MindOS" },
    { text: "Chhoti chhoti victories — badi safalta!", author: "MindOS" },
  ]

  // Aaj ki date se quote choose karo
  ...
  return (
    <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-4 text-center">
      ...
      <p className="text-indigo-400 text-xs mt-2">— {quote.author}</p>
    </div>
  )
}
